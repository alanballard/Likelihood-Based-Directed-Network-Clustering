...
3. Evaluate the final solution using k within-cluster densities and 2*kChoose2=2*(k)*(k-1) between-cluster densities
*/
...
*/
	...
	ofstream stats_file;
	stats_name << "MODULARITY3_STATS" << ".txt";
	stats_file.open("MODULARITY3_STATS.txt", ios::app);
...
//remove("MODULARITY3_SOLUTION_CLUSTERING_BIC.txt");
	bestzsol_BIC << "MODULARITY3_SOLUTION_CLUSTERING_BIC" << ".txt";
	bestzstorage_BIC.open("MODULARITY3_SOLUTION_CLUSTERING_BIC.txt", ios::app);
...
//	std::cout << "The membership vector for this clustering has been written to MODULARITY3_SOLUTION_CLUSTERING_BIC.txt." << endl;

	ostringstream bestzsol_AIC;
	ofstream bestzstorage_AIC;
	// If old file exists from a previous run, delete it.
//remove("MODULARITY3_SOLUTION_CLUSTERING_AIC.txt");
	bestzsol_AIC << "MODULARITY3_SOLUTION_CLUSTERING_AIC" << ".txt";
	bestzstorage_AIC.open("MODULARITY3_SOLUTION_CLUSTERING_AIC.txt", ios::app);
...
//	std::cout << "The membership vector for this clustering has been written to MODULARITY3_SOLUTION_CLUSTERING_AIC.txt." << endl;
